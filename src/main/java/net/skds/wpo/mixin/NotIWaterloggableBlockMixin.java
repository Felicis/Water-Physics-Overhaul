...
@Mixin({
        ...
        // TODO adding properties does not scale => find different strategy
...
public abstract class NotIWaterloggableBlockMixin implements WPOFluidloggableMarker, IWaterLoggable {
