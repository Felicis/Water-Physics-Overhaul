...
import net.skds.wpo.fluidphysics.actioniterables.AbstractFluidActionIterable;
...
public class Equalizer2 extends AbstractFluidActionIterable2<Void> {
    private final FlowingFluid fluid;
    int levelsAtStartPos;
    Map<BlockPos, FluidState> states = new HashMap<>();

    public Equalizer2(World world, BlockPos startPos, FlowingFluid fluid) {
