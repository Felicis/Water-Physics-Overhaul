...
public abstract class AbstractFlowIterator<T> {
    World world;
    BlockPos startPos;
    int maxRange;
     ...
     */
    protected AbstractFlowIterator(World world, BlockPos startPos, int maxRange) {
        this.world = world;
    ...
    protected List<Direction> getNextDirections() {
        return FluidStatic.getDirsDownRandomHorizontalUp(world.getRandom());
    }
