...
//	int sum;
//
//	public FFluidDefault(ServerWorld w, BlockPos pos, WorldWorkSet owner, FFluidBasic.Mode mode, int worker) {
...
//			synchronized (w) {
//				w.getLiquidTicks().scheduleTick(pos, fluid, fluid.getTickDelay(w));
//			}
//			return;
//		}
//
