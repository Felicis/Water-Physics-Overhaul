...
//	}
//
//	protected boolean UNUSED_flow(BlockPos fromPos, BlockPos toPos, int h) {
//		if (!validate(fromPos)) {
//			return false;
//		}
//		if (!validate(toPos)) {
...
//		}
//		boolean ss = true;
//		BlockState state1 = getBlockState(fromPos);
//		BlockState state2 = getBlockState(toPos);
//		if (UNUSED_canOnlyFillCube(state1) || UNUSED_canOnlyFillCube(state2)) {
//			unban(fromPos);
//			unban(toPos);
//			return false;
//		}
//		point1: if (!UNUSED_trySwap(fromPos, toPos, h, state1, state2)) {
...
//
//				Direction dir = dirFromVec(fromPos, toPos);
//				if (fs1.canBeReplacedWith(w, toPos, f2, dir)) {
//
...
//				setState(fromPos, sn1);
//				setState(toPos, sn2);
//			} else {
//				int sum = l1 + l2;
//				if (sum > MAX_FLUID_LEVEL) {
//					if (h > 0) {
//						l1 = MAX_FLUID_LEVEL;
//						l2 = sum - MAX_FLUID_LEVEL;
//					} else {
//						l2 = MAX_FLUID_LEVEL;
//						l1 = sum - MAX_FLUID_LEVEL;
//					}
//				} else {
//					if (h > 0) {
//						l1 = sum;
...
//	}
//
//	protected boolean UNUSED_trySwap(BlockPos pos1, BlockPos pos2, int h, BlockState state1, BlockState state2) {
//		// if (h == 0) {
//		// return false;
//		// }
//		// FluidState fs1 = state1.getFluidState();
...
//
//	protected boolean UNUSED_canOnlyFillCube(BlockState bs) {
//        return false;
//    }
//
...
//		castOwner.addNTTask(l, fluid.getTickDelay(w));
//	}
//
...
//	}
//
//	protected boolean UNUSED_flowFullCubeV2(BlockPos pos1, BlockPos pos2) {
//		if (!validate(pos1)) {
//			return false;
//		}
//		if (!validate(pos2)) {
...
//		if ((l1 == MAX_FLUID_LEVEL && l2 == 0) || (l1 == 0 && l2 == MAX_FLUID_LEVEL)) {
...
//		return FFluidStatic.forceApplyFluid(state0, newLevel, (FlowingFluid) fluid);
//	}
//
//	// ================ UTIL ================== //
//
...
//			return false;
//		}
//		return FFluidStatic.canFlow(w, pos1, pos2, state1, state2, fluid);
//	}
//
