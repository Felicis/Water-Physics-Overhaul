...
//					if (ld == 0 && l == MAX_FLUID_LEVEL && UNUSED_flowFullCubeV2(pos, posD)) {
//						dc = true;
//						return;
//					}
//				} else {
//					if (UNUSED_flow(pos, posD, -1)) {
//						addPassedEq(posD);
//						dc = true;
//						sc = true;
//					}
...
//						if (UNUSED_flowFullCubeV2(pos, pos2)) {
//							sc = true;
//							return;
//						}
//					}
...
//				}
//			} else {
//				sc = !dc && canFlow(pos, pos2, state, state2, false, false) && UNUSED_flow(pos, pos2, 0);
//			}
//		}
//
